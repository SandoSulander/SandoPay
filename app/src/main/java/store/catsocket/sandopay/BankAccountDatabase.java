...
@Database(entities = {User.class, DebitAccount.class, AccountTransaction.class}, version = 1)  //If DataBase gets Corrupted OR Changes on the Schema are made --> increment version +1
